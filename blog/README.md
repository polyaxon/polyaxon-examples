...
| --- | --- | --- |
| [hyperparameter-seeds](hyperparameter-seeds/) | Two SGD recipes across five matched training seeds, validation predictions, paired summaries, and an optional tracked job for **Did you find better hyperparameters—or a lucky seed?** Publication pending. | Python 3.12 and supplied requirements; configured Polyaxon CLI/deployment for optional execution. Upload with `-u`; install dependencies at startup. Source-reviewed, not executed. |
